...
library(rtweet)
### Query used:
## search_tweets(q = "#carpentrycon2018 OR @carpentrycon", include_rts = FALSE, n = 10000) %>%
##    saveRDS(file = "2018carpentrycon_tweets_no_rts.rds")
```
...
Gitlab at:
[https://gitlab.com/fmichonneau/carpentrycon2018-tweets](https://gitlab.com/fmichonneau/carpentrycon2018-tweets).
